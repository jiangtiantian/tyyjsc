 ...
 * 找回支付密码
 */
public class ActivitySetPayPwd extends BaseActivity implements View.OnClickListener{
    ...
    protected void findView() {
        ...
        hmBarNameView.setText("修改/设置支付密码");
    ...
    protected void callBackForServerSuccess(HemaNetTask hemaNetTask, HemaBaseResult hemaBaseResult) {
        ...
        switch (information) {
            ...
            case CODE_VERIFY:
                ...
                getNetWorker().payPasswordAdd(tempToken,"2",new_pwd.getText().toString());
                break;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.next:
                ...
                String pwdtxt=new_pwd.getText().toString();
                if (isNull(username)) {
    ...
    private static class TimeHandler extends Handler {
        ActivitySetPayPwd activity;

        public TimeHandler(ActivitySetPayPwd activity) {
