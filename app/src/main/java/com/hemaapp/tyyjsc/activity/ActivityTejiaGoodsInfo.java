 ...
 * 特价预定( 一成购车)商品
 */
public class ActivityTejiaGoodsInfo extends BaseActivity implements View.OnClickListener {
    ...
    public void getGoodsInfo() {
        getNetWorker().getGoodsInfo(good_id, "3");
    }
        ...
        if (user == null) {
            ...
            win.setListener(new AttrSelectorDialog.onAddCardListener() {
                ...
                public void onAddCart(String specName, String spec_id, String num, String price, String weight) {
                    win.cancel();
                    getNetWorker().cartAdd(user.getToken(), "3", info.getId(), spec_id, num);
                }
            });
            win.show();
        }
