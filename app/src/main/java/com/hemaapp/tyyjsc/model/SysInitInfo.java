...
public class SysInitInfo extends XtomObject {
    ...
    private String sys_service_qq;//QQ
    ...
    private String start_img; // 广告业的地址
    ...
    public SysInitInfo(String sys_web_service, String sys_plugins,
                       String sys_show_iospay, String android_must_update,
                       ...
                       String iphone_comment_url, String msg_invite, String start_img, String sys_service_qq) {
        super();
        ...
        this.sys_service_qq = sys_service_qq;
    }
