 ...
 *商品列表任务
 */
public class GoodsListNoPageTask extends BaseNetTask {

    public GoodsListNoPageTask(BaseHttpInformation information,
    ...
    private class Result extends HemaArrayResult<GoodsBriefIntroduction> {
