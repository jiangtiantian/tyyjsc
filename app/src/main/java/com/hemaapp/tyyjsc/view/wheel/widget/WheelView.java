...
package com.hemaapp.tyyjsc.view.wheel.widget;
...
import com.hemaapp.tyyjsc.view.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    /**
	 * private int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF, 0x00FFFFFF,
	 * 0x00FFFFFF };
	 */
    ...
    private void drawCenterRect(Canvas canvas) {
		...
		/*
		 * / Remarked by wulianghuan 2014-11-27 Rect rect = new Rect(left, top,
		 * right, bottom) centerDrawable.setBounds(bounds)
